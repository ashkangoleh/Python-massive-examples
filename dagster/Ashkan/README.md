...
You can start writing assets in `Ashkan/assets.py`. The assets are automatically loaded into the Dagster code location as you define them.
...
Tests are in the `Ashkan_tests` directory and you can run tests using `pytest`:
